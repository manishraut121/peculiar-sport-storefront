const ITEMS = [
  {
    t: "Free shipping over ₹2,999",
    d: "M3 7h11v8H3zM14 10h4l3 3v2h-7z",
  },
  {
    t: "Handcrafted in India",
    d: "M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z",
  },
  {
    t: "Secure UPI · card · net-banking",
    d: "M4 7h16v10H4z M4 10h16",
  },
  {
    t: "Easy 7-day returns",
    d: "M3 12a9 9 0 0 1 15-6.7L21 8 M21 3v5h-5",
  },
]
  ...
  return (
    <div className="border-b border-ui-border-base bg-crease">
      <div className="content-container overflow-x-auto no-scrollbar">
        <ul className="flex items-center justify-between gap-6 h-11 min-w-max small:min-w-0 text-[12px] text-mist list-none m-0 p-0">
          {ITEMS.map((i) => (
            <li key={i.t} className="flex items-center gap-2 whitespace-nowrap">
              <svg
                ...
                stroke="currentColor"
                strokeWidth="1.6"
                className="text-boundary shrink-0"
                aria-hidden
              >
